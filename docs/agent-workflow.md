...
This repository supports a terminal-first workflow with one primary coding agent and an optional remote Ollama sidecar on `YOUR_LLM_HOST:11434`.
...
```bash
export DEEPSEEK_BASE_URL=http://YOUR_LLM_HOST:11434
export DEEPSEEK_MODEL=deepseek-coder:6.7b
```
