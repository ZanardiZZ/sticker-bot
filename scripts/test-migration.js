...
const { migrateHistoricalContacts } = require('../src/database/index.js');
    ...
    await new Promise((resolve, reject) => {
      testDb.serialize(() => {
        ...
        testDb.run(`
          ...
          ('test1', '5511000000000@c.us', 'test1.webp', 'image/webp', 1640995200),
        ...
        testDb.run(`
          ...
          ('5511000000000@c.us', 'Usuario Existente')
        `, (err) => {
          if (err) reject(err);
          else resolve();
        });
