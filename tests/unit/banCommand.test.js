...
const tests = [
  {
    ...
    fn: async () => {
      ...
      const message = {
        ...
        mentionedJid: ['5511000000000@c.us'], // Mentioned user
        sender: { isAdmin: true },
        key: {
      ...
      assertEqual(client.groupParticipantsUpdateCalls[0].participants[0], '5511000000000@c.us', 'Should target mentioned user');
  ...
  
  {
    ...
    fn: async () => {
      ...
      const message = {
        ...
        id: 'test-message-id',
        from: '123456789@g.us',
        mentionedJid: ['5511000000000@c.us'],
...

  {
    ...
    fn: async () => {
      ...
      const message = {
        mentionedJid: ['5511000000000@c.us', '5511888888888@c.us']
      };
      
      const result = extractMentionedJid(message);
      assertEqual(result, '5511000000000@c.us', 'Should extract first mentioned JID');
    }
  },
