...
- **Arquivo:** `<PROJECT_ROOT>/bot/media/media-1769304434724.webp`
...
- **Arquivo:** `<PROJECT_ROOT>/bot/media/media-1769339038319.webp`
...
1. **Visualizar as imagens:**
   ```bash
   ls -lh <PROJECT_ROOT>/bot/media/media-1769304434724.webp
   ls -lh <PROJECT_ROOT>/bot/media/media-1769339038319.webp
   ```
