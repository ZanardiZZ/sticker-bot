...
- Runtime: Node.js from [`.nvmrc`](<PROJECT_ROOT>/.nvmrc)
- Package manager: `npm`
...
The repository includes wrappers for a remote Ollama host at `YOUR_LLM_HOST:11434`.
...
- [index.js](<PROJECT_ROOT>/index.js): bot entry point
- [server.js](<PROJECT_ROOT>/server.js): bridge entrypoint wrapper
- [src/server/bridge.js](<PROJECT_ROOT>/src/server/bridge.js): WhatsApp bridge server and websocket fanout
- [src/bot/](<PROJECT_ROOT>/src/bot): message handling, media processing, stickers
- [src/commands/](<PROJECT_ROOT>/src/commands): command handlers
- [src/database/](<PROJECT_ROOT>/src/database): db bootstrap and models
- [src/services/](<PROJECT_ROOT>/src/services): AI, NSFW, video, external integrations
- [src/web/](<PROJECT_ROOT>/src/web): web server, routes, auth, static admin UI
- [storage/](<PROJECT_ROOT>/storage): local runtime data, tokens, logs, and caches
- [media/](<PROJECT_ROOT>/media): local bot media storage; do not treat it as source code
- [scripts/agent/](<PROJECT_ROOT>/scripts/agent): local agent tooling
...
- [src/server/bridge.js](<PROJECT_ROOT>/src/server/bridge.js): avoid unbounded maps, intervals, websocket client leaks, or retaining large raw message objects
- [src/bot/mediaProcessor.js](<PROJECT_ROOT>/src/bot/mediaProcessor.js): test doubles may omit optional functions; keep graceful fallbacks
- [src/bot/messageHandler.js](<PROJECT_ROOT>/src/bot/messageHandler.js): preserve tolerant behavior for partial mocks and duplicate-processing guards
- [src/bot/stickers.js](<PROJECT_ROOT>/src/bot/stickers.js): animated WebP detection must preserve VP8X fallback coverage
- [src/web/server.js](<PROJECT_ROOT>/src/web/server.js): keep auth, route registration, and db init consistent with tests
...
- Agent workflow: [docs/agent-workflow.md](<PROJECT_ROOT>/docs/agent-workflow.md)
- Agent overview: [.github/agents/README.md](<PROJECT_ROOT>/.github/agents/README.md)
- Expert agent profile: [.github/agents/sticker-bot-expert.md](<PROJECT_ROOT>/.github/agents/sticker-bot-expert.md)
- Bot guide: [.github/agents/BOT.md](<PROJECT_ROOT>/.github/agents/BOT.md)
- Web guide: [.github/agents/WEB.md](<PROJECT_ROOT>/.github/agents/WEB.md)
- Operations guide: [.github/agents/OPERATIONS.md](<PROJECT_ROOT>/.github/agents/OPERATIONS.md)
- Testing guide: [.github/agents/TESTING.md](<PROJECT_ROOT>/.github/agents/TESTING.md)
