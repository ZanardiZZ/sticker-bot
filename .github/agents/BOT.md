...
- [index.js](<PROJECT_ROOT>/index.js)
- [server.js](<PROJECT_ROOT>/server.js)
- [src/server/bridge.js](<PROJECT_ROOT>/src/server/bridge.js)
- [src/bot/messageHandler.js](<PROJECT_ROOT>/src/bot/messageHandler.js)
- [src/bot/mediaProcessor.js](<PROJECT_ROOT>/src/bot/mediaProcessor.js)
- [src/bot/stickers.js](<PROJECT_ROOT>/src/bot/stickers.js)
- [src/commands/](<PROJECT_ROOT>/src/commands)
