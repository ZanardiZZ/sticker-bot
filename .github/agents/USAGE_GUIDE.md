...
```bash
DEEPSEEK_BASE_URL=http://YOUR_LLM_HOST:11434 \
...
1. Inspect [src/bot/mediaProcessor.js](<PROJECT_ROOT>/src/bot/mediaProcessor.js) and [src/bot/stickers.js](<PROJECT_ROOT>/src/bot/stickers.js).
...
1. Inspect [src/server/bridge.js](<PROJECT_ROOT>/src/server/bridge.js).
...
1. Change the scripts under [scripts/agent/](<PROJECT_ROOT>/scripts/agent).
