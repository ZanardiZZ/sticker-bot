...
- [src/web/server.js](<PROJECT_ROOT>/src/web/server.js)
- [src/web/auth.js](<PROJECT_ROOT>/src/web/auth.js)
- [src/web/dataAccess.js](<PROJECT_ROOT>/src/web/dataAccess.js)
- [src/web/routes/](<PROJECT_ROOT>/src/web/routes)
- [src/web/public/](<PROJECT_ROOT>/src/web/public)
