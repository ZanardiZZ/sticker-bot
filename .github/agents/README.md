...
1. [`.github/copilot-instructions.md`](<PROJECT_ROOT>/.github/copilot-instructions.md)
2. [`docs/agent-workflow.md`](<PROJECT_ROOT>/docs/agent-workflow.md)
3. [`sticker-bot-expert.md`](<PROJECT_ROOT>/.github/agents/sticker-bot-expert.md)
4. One domain guide:
...
5. [`USAGE_GUIDE.md`](<PROJECT_ROOT>/.github/agents/USAGE_GUIDE.md)
...
- [`sticker-bot-expert.md`](<PROJECT_ROOT>/.github/agents/sticker-bot-expert.md): repository-specific guidance
- [`BOT.md`](<PROJECT_ROOT>/.github/agents/BOT.md): bot and media changes
- [`WEB.md`](<PROJECT_ROOT>/.github/agents/WEB.md): web and auth changes
- [`OPERATIONS.md`](<PROJECT_ROOT>/.github/agents/OPERATIONS.md): agent tooling and Ollama workflow
- [`TESTING.md`](<PROJECT_ROOT>/.github/agents/TESTING.md): validation guide
- [`USAGE_GUIDE.md`](<PROJECT_ROOT>/.github/agents/USAGE_GUIDE.md): practical prompts and workflows
- [`agents.json`](<PROJECT_ROOT>/.github/agents/agents.json): machine-readable metadata
- [`IMPLEMENTATION_SUMMARY.md`](<PROJECT_ROOT>/.github/agents/IMPLEMENTATION_SUMMARY.md): what this doc set currently assumes

Root wrappers such as [`index.js`](<PROJECT_ROOT>/index.js) and [`server.js`](<PROJECT_ROOT>/server.js) exist mainly to preserve stable entrypoints; most implementation lives under `src/`.
